...
export default function Hero() {
  return (
    <section className="relative px-4 pt-4 sm:px-6 sm:pt-6">
      <div className="hero-panel mx-auto max-w-6xl overflow-hidden rounded-[1.75rem] sm:rounded-[2rem]">
        <div className="px-5 pb-2 pt-8 text-center sm:px-10 sm:pt-10 md:px-12">
          <span className="inline-flex rounded-full bg-[var(--brand-bg-mint)] px-4 py-1.5 text-[11px] font-semibold text-[var(--brand-dark)] sm:text-xs">
