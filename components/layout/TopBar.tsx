...
export default function TopBar() {
  return (
    <div className="relative z-40 px-4 pt-2 sm:px-6">
      <div className="topbar-promo mx-auto flex max-w-6xl flex-col items-center justify-between gap-2.5 rounded-2xl border border-[var(--brand-primary)]/15 bg-gradient-to-r from-[var(--brand-primary)]/12 via-white/70 to-[var(--brand-bg-mint)]/50 px-4 py-2.5 shadow-[0_4px_24px_rgba(145,70,255,0.12)] backdrop-blur-md sm:flex-row sm:gap-4 sm:px-5 sm:py-2.5">
