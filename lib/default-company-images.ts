 ...
 * Mínimo 10 imágenes únicas por sector. Se elige una estable por empresa (id/sector) y opcionalmente
 * por posición en el grupo para que cartas adyacentes no repitan imagen.
 */
...
// Mínimo 10 imágenes únicas por sector (sin repetición en el mismo array)
...
// Asegurar mínimo 10 por sector: rellenar con Otros si hace falta
